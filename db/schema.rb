...
ActiveRecord::Schema.define(version: 2021_01_28_005118) do
  ...
  create_table "warehouse_records", force: :cascade do |t|
    ...
    t.index ["suppliers_id"], name: "index_warehouse_records_on_suppliers_id"
  end

  add_foreign_key "products", "categories"
  add_foreign_key "products", "suppliers"
  add_foreign_key "warehouse_records", "products", column: "products_id"
  add_foreign_key "warehouse_records", "suppliers", column: "suppliers_id"
end
